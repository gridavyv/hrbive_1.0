...
INSTRUCTIONS_TO_SHOOT_VIDEO_TEXT = (
    "📹 Запишите кружочек прямо в этом чате или загрузите короткое приветственное видео (не более 60 сек).\n" 
    " • Несколько слов о компании, вакансии\n"
    " • Особые требования (если есть)\n"
    " • Смотрите в камеру и улыбайтесь 😊\n"
    " • Не переживайте о техническом качестве, главное - это вы и ваша энергетика.\n"
