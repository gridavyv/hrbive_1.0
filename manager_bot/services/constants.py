...
FAIL_TO_RECORD_WELCOME_VIDEO_TEXT = (
    "Мы не можем продолжить без приветственного видео.\n"
    "Хорошие соискатели не записывают видео-визитки если им не показать видео-интро от менеджера.\n"
    f"пожалуйста, запишите видео-интро.\n{INFO_ABOUT_MENU_TEXT}"
)

# ----- USER MESSAGES CONSTANTS with MISSING DATA status-----

MISSING_PRIVACY_POLICY_CONFIRMATION_TEXT = f"Для продолжения работы необходимо согласие на обработку персональных данных.\n{INFO_ABOUT_MENU_TEXT}"
